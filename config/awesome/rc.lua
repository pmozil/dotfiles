...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,  "Shift"  }, "Left",   awful.tag.viewprev,
              {description = "view previous", group = "tag"}),
    awful.key({ modkey,  "Shift"  }, "Right",   awful.tag.viewprev,
              {description = "view previous", group = "tag"}),
    awful.key({ modkey,           }, "Right",  awful.tag.viewnext,
              {description = "view next", group = "tag"}),

    --awful.key({ "" }, "space", function () kbdcfg.switch() end),
    ...
    awful.key({ "Shift"}, "#107",
            function()
                awful.spawn.with_shell("sleep 0.2 && scrot -s")
            end, { description = "take screenshot from selected", group = 
"launcher" }),
    awful.key({}, "#107",
            function()
                awful.spawn.with_shell("sleep 0.2 && scrot")
...
"launcher" }),
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () awful.spawn.with_shell("rofi -show 2>&1 | while read ERROR; do wait 0 \"$ERROR\"; done")end,
